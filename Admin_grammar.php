...
if(isset($_POST['add_ques'])){
   ...
   if(empty($Question) || empty($Ques_opt1) || empty($Ques_opt2) || empty($Ques_opt3) || empty($Ques_opt4) || empty($ans)
   ){
      $message[] = 'please fill out all';
   }else{
      $insert = "INSERT INTO table_grammar(que, option_1, option_2, option_3, option_4,ans) 
      VALUES('$Question','$Ques_opt1','$Ques_opt2',  '$Ques_opt3',  '$Ques_opt4', '$ans')";
...
if(isset($_GET['delete'])){
   $id = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM table_grammar WHERE id = $id");
   header('location:Admin_Grammar.php');
};
...
<div class="row d-flex justify-content-center">
   <div class="col-md-6">
        <div class="form-group">
            <h1 class="text-center">Manage Grammar Page</h1>
         ...
         <input type="text" placeholder="Enter the Question" name="Question" class="form-control"><br/>
         ...
         <div class="text-center">
            <input type="submit" class="btn btn-primary" name="add_ques" value="Add Question">
         </div>
         <br/>
      </form>
</div>
   ...
   $select = mysqli_query($conn, "SELECT * FROM table_grammar");
   ...
   <br/>
      <table class="table table-striped table-hover">
         ...
         <tr>
            ...
            <td>
               <!-- <a href="Admin_grammar.php?edit=<?php echo $row['id']; ?>" class="btn btn-success">edit </a> -->
               <a href="Admin_grammar.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
