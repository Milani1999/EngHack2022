...
<?php 														
    ...
    if (isset($_POST['click']) || isset($_GET['start'])) {
	    ...
	    $c = $_SESSION['clicks'];
			if(isset($_POST['userans'])) { $userselected = $_POST['userans'];
				...
				$fetchqry2 = "UPDATE `table_writing` SET `userans`='$userselected' WHERE `id`=$c-1"; 
	...
	?>
    <br/><h1>Listen and type the word without any spelling mistakes</h1><br/>
...
<table><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `table_writing` where id='$c'"; 
  ...
  <tr><td><textarea name="userans" rows="3" cols="50"></textarea><br></td></tr>
